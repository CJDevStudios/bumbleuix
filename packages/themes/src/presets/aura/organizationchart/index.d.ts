import type { OrganizationChartTokenSections } from '@cjdevstudios/bumbleuix-themes/types/organizationchart';

export * from '@cjdevstudios/bumbleuix-themes/types/organizationchart';
