import type { ConfirmPopupTokenSections } from '@cjdevstudios/bumbleuix-themes/types/confirmpopup';

export * from '@cjdevstudios/bumbleuix-themes/types/confirmpopup';
