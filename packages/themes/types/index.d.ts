 ...
 *
 */
import type { StyleOptions, ThemeOptions } from '@cjdevstudios/bumbleuix-styled';
...
// @todo: Remove this when the types are fixed in the styled package. Use `ColorScale` from `@cjdevstudios/bumbleuix-styled` instead.
